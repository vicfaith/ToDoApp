...
package com.example.dkang.myapplication.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.dkang.myapplication.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase("https://my-first-app-4597d.firebaseio.com/todoItems");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@my-first-app-4597d.appspotmail.com",
                            "Todo Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("vicfaith2010@gmail.com", "Recipient"));
